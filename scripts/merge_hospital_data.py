...
def convert_and_merge_hospital():
    # File paths
    base_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
    file_2022 = os.path.join(base_dir, 'data', 'raw', 'hospital_v2_2022.xlsx')
    file_2024 = os.path.join(base_dir, 'data', 'raw', 'hospital_v2_2024.xlsx')
    ...
    df_2022['year'] = 2022
    csv_2022 = os.path.join(base_dir, 'data', 'raw', 'hospital_v2_2022.csv')
    ...
    df_2024['year'] = 2024
    csv_2024 = os.path.join(base_dir, 'data', 'raw', 'hospital_v2_2024.csv')
    ...
    output_file = os.path.join(base_dir, 'data', 'processed', 'hospital_22_24.csv')
